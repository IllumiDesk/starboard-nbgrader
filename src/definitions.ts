...
export const GraderCellTypeDefinitions: Record<GraderCellType, GraderCellTypeDefinition> = {
  "manual-answer": {
    ...
    emoji: "✏️",
    description: html` <p>
      In a <b>graded answer cell</b> the student enters their answer in a specific location in this cell. <br />This makes it a good choice
      for free-form answers. After submission these cells are graded manually.
    </p>`,
  },
  "manual-task": {
    id: "manual-task",
    ...
    emoji: "📝",
    description: html` <p>
      In a <b>graded task</b> the student adds their answer across the notebook. <br />Use this for free-form answers that span multiple
      cells, or for tasks that are global (e.g. <i>"Make sure all Python code follows the PEP8 style guidelines"</i>). After submission
      these cells graded manually.
    </p>`,
  },
  "autograder-answer": {
    ...
    description: html` <p>
      ...
      <details>
        ...
        <p>
          The student's answer is delimited by special <code>BEGIN SOLUTION</code> and <code>END SOLUTION</code> comments, anything in this
          section will not be visible to the student.
        </p>
  ...
  "autograder-tests": {
    ...
    description: html`
      <p>
        An <b>Auto-grader test</b> cell is used to score code assignments automatically. Points are only scored if all tests in the cell
        pass.
      </p>
      <details>
        <summary>View Example</summary>
...
<b>### END HIDDEN TESTS</b>
  ...
  python: {
    ...
    hasPoints: false,
    emoji: "🐍",
    description: html` <p>A <b>Python</b> cell is a code cell that is not graded directly.</p> `,
  },
  markdown: {
    id: "markdown",
    name: "Markdown",
    supportedCellTypes: ["markdown"],
    hasPoints: false,
    emoji: "📃",
    description: html` <p>A <b>Markdown</b> cell is used for content that is not graded.</p> `,
  },
};
 ...
 * This is used when switching from one grader cell type to another.
 */
export function convertNBGraderType(md: NBGraderMetadata, newType: GraderCellType, pointCount: number) {
  if (newType === "manual-answer") {
    ...
    md.points = md.points || pointCount;
  } else if (newType === "python" || newType === "markdown") {

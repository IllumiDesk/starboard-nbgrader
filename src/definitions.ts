...
export const GraderCellTypeDefinitions: Record<GraderCellType, GraderCellTypeDefinition> = {
    "manual-answer": {
        ...
        <p>
            ...
            <br>This makes it a good choice for free-form answers. After submission these cells are graded manually.
     </p>`
    },
    "manual-task": {
        id: "manual-task",
        ...
        description: html`
         <p>
             ...
             <br>Use this for free-form answers that span multiple cells, or for tasks that are global (e.g. "Make sure all Python code follows the PEP8 style guidelines"). After submission these cells graded manually.
      </p>`},
    "autograder-answer": {
        ...
        description: html`
    <p>
        An <b>Auto-graded task</b> is a code assignment that is graded automatically.
        Points are earned in separate <b>Auto-grader test</b> cells.
    </p>
    <details>
        <summary>View Example</summary>
        <p>
            The student's answer is delimited by special <code>BEGIN SOLUTION</code> and <code>END SOLUTION</code> comments, anything in this section will not be visible to the student.
        </p>
    ...
    "autograder-tests": {
        ...
        description: html`
    <p>
    An <b>Auto-grader test</b> cell is used to score code assignments automatically. Points are only scored if all tests in the cell pass.
    </p>
    <details>
        <summary>View Example</summary>
        <p>
        Test conditions can be hidden from the student using special <code>BEGIN HIDDEN TESTS</code> comments.
        </p>

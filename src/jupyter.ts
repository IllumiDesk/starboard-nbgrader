...
export async function registerJupyterPlugin(
  ...
  pluginUrl: string = "https://unpkg.com/starboard-jupyter@0.2.9/dist/index.js"
) {
...
export function getJupyterPlugin(): typeof JPlugin {
  return singletonPlugin as typeof JPlugin;
}
